...
public class MentorDAO {
    ...
    private static final String INSERTCV = "UPDATE Mentor SET Job=?,Introducton=?,Profession=?,ProfessionIntro=?,Framework=?,Service=?,ServiceDesc=?,AchievementDesc=?,Avatar=? WHERE ID=?";
    ...
    public boolean insertcv(Mentor mentor) throws SQLException{
        boolean check = false;
        Connection con = null;
        PreparedStatement stm = null;
        try{
