...
<html>
    ...
    <body>
        <nav class="container-fluid header ">
            <div class="row">
                <a class="col-md-7" href="MentorHomePage.jsp"><img  class="logo" src="image/cafe2.png" /></a>
                ...
                <div class="col-md-1 d-flex">
                    <a  href=""><img style="background-color: white" class="avatar" src="image/avatar_male.png.png" /></a>
