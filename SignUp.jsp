    ...
    <body>
        ...
        <div class="body">
            ...
            <table style=";font-size: 25px" class="d-flex justify-content-center" id="signuptable">
                <tr><td id="signupname">Account Name</td><td><input type ="text", id="signupform", name="accountName">"required>
                        <p style="color : red; font-size:20px"><%=userError.getAccError()%></p></td></tr>
                <tr><td id="signupname">Email</td><td><input type ="text", id="signupform", name="email" required>
                        <p style="color : red; font-size:20px"><%=userError.getEmailError()%></p>
<!--                    <a href = "mailto: abc@example.com"></a> --></td></tr>
                <tr><td id="signupname">Password</td><td><input type ="password", id="signupform", name="password" required></td></tr>
                <tr><td id="signupname">Confirm Password</td><td><input type ="text", id="signupform", name="confirm" required>
                        <p style="color : red; font-size:20px"><%=userError.getPassError()%></p></td></tr>
                <tr><td id="signupname">Full Name</td><td><input type ="text", id="signupform", name="fullName" required></td></tr>            
                <tr><td id="signupname">Phone Number</td><td><input type ="", id="signupform", name="phone" required>
                        <p style="color : red; font-size:20px"><%=userError.getPhoneError()%></p></td></tr>            
                <tr><td id="signupname">Date of Birth</td><td><input type ="date", id="signupform", name="dob" required></td></tr>
