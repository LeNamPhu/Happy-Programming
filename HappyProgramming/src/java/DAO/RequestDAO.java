...
public class RequestDAO {
    ...
    public static final String LIST_FOLLOWING_REQUEST = "SELECT Request.ID, Title, Content,MenteeID, DeadlineDate, DeadlineHour, Name FROM ((Request join Invite on Request.ID = Invite.ReqID) join RequestSkill on Request.ID = RequestSkill.RequestID) join Skill on RequestSkill.SkillID = Skill.ID WHERE MentorID = ? And Request.Status = 'Closed'";
