<%-- 
    Document   : AdminViewMentorSearch
    Created on : Jun 29, 2022, 7:44:14 PM
    Author     : DELL
--%>
...
>>>>>>> Stashed changes
            ...
            <nav aria-label="Page navigation example" style="margin-top:100px;margin-left: 450px ">
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="AdminViewMentorSearch.jsp?page=<%=i%>&txtsearch=<%=request.getParameter("txtsearch")%>"><%=i%></a></li>
                        <%  }
                        %>
