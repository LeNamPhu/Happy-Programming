<%-- 
    Document   : InvitingRequest
    Created on : Jun 28, 2022, 1:44:49 PM
    Author     : ADMIN
--%>
...
<body>
    <%ArrayList<Request> list = (ArrayList) session.getAttribute("LIST_INVITING_REQUEST");%>
    <%if (list.isEmpty()) {%>
    ...
    <table> 
        ...
        <tr>
            ...
            <td>
                <button type="submit" name="action" value="FollowingRequest" >Accept</button>
                <button type="submit" name="action" value="FollowingRequest" >Reject</button>
            </td>
